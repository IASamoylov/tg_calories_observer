...
//
//	mockgen -source=dependecies.go -destination=dependecies_mocks.go -package=commandrouter . userStorage,telegram,commandRouterHandler
//
// Package commandrouter is a generated GoMock package.
...
func (mr *MockuserStorageMockRecorder) Upsert(ctx, user any) *gomock.Call {
...
func (mr *MocktelegramMockRecorder) InitMenu(commands any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MocktelegramMockRecorder) SendErr(receiver, err any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockcommandRouterHandler) Execute(ctx context.Context, sender dto.User, args string) (tgbotapi.Chattable, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Execute", ctx, sender, args)
...
func (mr *MockcommandRouterHandlerMockRecorder) Execute(ctx, sender, args any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Execute", reflect.TypeOf((*MockcommandRouterHandler)(nil).Execute), ctx, sender, args)
}
